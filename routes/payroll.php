...
Route::middleware(['auth', 'verified', 'permission:view_payroll'])
    ->prefix('payroll')
    ->group(function () {
        ...
        Route::middleware('permission:export_payroll_reports')->group(function () {
            Route::get('/summary', function () {
                return view('pages.payroll.summary');
            })->name('payroll.summary');

            Route::get('/reports', [PayrollReportController::class, 'index'])->name('payroll.reports');
            Route::get('/reports/export', [PayrollReportController::class, 'export'])->name(
        ...
        Route::prefix('api')->group(function () {
            ...
            Route::get('/summary-stats', [PayrollController::class, 'getSummaryStats'])
                ...
                ->middleware('permission:export_payroll_reports');
