...
class ScheduleController extends Controller
{
    ...
    public function calendar()
    {
        ...
        return view('pages.schedules.calendar', compact('academicClasses', 'timeSlots'));
    }
    ...
    public function getCalendarData()
    {
        ...
        foreach ($schedules as $schedule) {
            ...
            $endDate = min(
                $schedule->end_date ?? now()->endOfMonth()->addMonth(),
    ...
    public function getPeriodsData()
    {
        ...
        return DataTables::of($periods)
            ...
            ->addColumn('actions', function ($period) {
                return '
                    <div class="btn-list">
                        <button class="btn btn-sm btn-primary assign-employees" data-period-id="'.
                  $period->id.
                  '">
                            Assign
                        </button>
                        <button class="btn btn-sm btn-info view-assignments" data-period-id="'.
                  $period->id.
                  '">
                            View
                        </button>
            ...
            foreach ($validated['employee_ids'] as $employeeId) {
                ...
                $conflicts = EmployeeSchedule::where('employee_id', $employeeId)
                    ->whereHas('period', function ($query) use ($period) {
                        $query->where('day_of_week', $period->day_of_week)->where(function ($q) use ($period) {
    ...
    public function downloadTemplate()
    {
        ...
        $csv =
          "Period Name,Day of Week,Start Time,End Time,Subject,Room,Employee ID,Effective Date,End Date\n";
