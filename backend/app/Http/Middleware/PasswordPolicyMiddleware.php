...
class PasswordPolicyMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if ($user->isLocked()) {
            ...
            $message =
              'Your account has been locked due to security reasons. Please contact an administrator.';
    ...
    {
        $excludedApiRoutes = ['api/v1/auth/logout', 'api/v1/auth/user', 'api/v1/password/change'];
