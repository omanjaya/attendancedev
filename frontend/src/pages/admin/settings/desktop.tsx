                            ...
                            <div className="grid grid-cols-3 gap-4">
                                {(['light', 'dark', 'system'] as Theme[]).map((theme) => (
                                    <button
                                        ...
                                        className={`flex flex-col items-center gap-2 p-4 rounded-lg border-2 transition-colors ${settings.appearance.theme === theme
                                            ? 'border-primary bg-primary/5'
                                            : 'border-border hover:border-primary/50'
                                            }`}
                                    >
                                        <div
                                            className={`p-3 rounded-full ${settings.appearance.theme === theme
