...
@php
    ...
    $selectedValues = old($name, (array) $value);
            ...
            <div class="flex items-start space-x-3">
                <div class="flex items-center h-5">
                    <input
                        ...
                        class="{{ $checkboxSize }} rounded border-input text-primary focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 transition-colors"
                    />
                </div>
