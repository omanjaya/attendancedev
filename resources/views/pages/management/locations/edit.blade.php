...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-blue-900 dark:to-indigo-900">
    <div class="p-6 lg:p-8">
        <x-layouts.base-page
            title="Edit Lokasi: {{ $location->name }}"
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div class="space-y-2">
                                ...
                                <x-ui.input type="text" name="name" 
                                           value="{{ old('name', $location->name) }}" placeholder="Kampus Utama" required 
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="address" 
                                      ...
                                      rows="2" placeholder="123 Jalan Utama, Kota, Provinsi, Kode Pos">{{ old('address', $location->address) }}</textarea>
                            @error('address')
                                <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div class="space-y-2">
                                ...
                                <x-ui.input type="number" name="latitude" id="latitude" 
                                           value="{{ old('latitude', $location->latitude) }}" step="0.000001" placeholder="-6.2088" 
                                           class="bg-white/30 backdrop-blur-sm border border-white/40 text-slate-800 dark:text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-300" />
                                @error('latitude')
                                    <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="space-y-2">
                                ...
                                <x-ui.input type="number" name="longitude" id="longitude" 
                                           value="{{ old('longitude', $location->longitude) }}" step="0.000001" placeholder="106.8456" 
                                           class="bg-white/30 backdrop-blur-sm border border-white/40 text-slate-800 dark:text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-300" />
                                @error('longitude')
                                    <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                @enderror
